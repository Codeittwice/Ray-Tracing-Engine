...
enum class BodyPart {
    ...
    Post,  ///< A 12.7 mm (half-inch) post from the part's lowest point down to z = 0.
};

/// Post radius, metres: the standard half-inch optical post.
inline constexpr double kPostRadius = 0.00635;
